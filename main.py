...
def get_brteams_info(myteamname):
    ...
    for team in myteamname:
        ...
        elif myteamname[count] == "pain":
            print("Time -> PAIN GAMING")
            teamid = 4773
            teamname = "pain"
...
if __name__ == "__main__":
    ...
    pp.pprint(get_brteams_info(['pain', 'furia', 'imperial', 'oplano']))
